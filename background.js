        ...
        messages: [
          {
            ...
            content:
              ...
              "Translate each item to targetLanguage only if needed. Keep meaning and formatting. Input JSON: {targetLanguage,items:[{id,text}]}. Output ONLY JSON: {\"translations\":[{\"id\":\"...\",\"text\":\"...\"}]}. Preserve ids."
          },
          {
            role: "user",
            content: userPrompt
