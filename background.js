const DEFAULT_SETTINGS = {
  ...
  apiKey: "",
  systemPrompt:
    "You are an expert website translator. Detect the source language automatically for each text segment and translate it into the target language while preserving meaning, tone, and context. Keep punctuation, emojis, line breaks, placeholders, brand names, URLs, and code snippets unchanged unless translation is clearly needed. Return strictly valid JSON matching the requested schema."
};
      ...
      messages: [
        {
          ...
          content:
            ...
            "You will receive JSON: {targetLanguage, texts}. Return only JSON in this exact format: {\"translations\":[string,...]} with same length and same ordering as input."
        },
        {
          role: "user",
          content: userPrompt
